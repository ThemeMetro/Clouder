...
<div class="landing-page sitelock">
    ...
    <div class="content-block">
        <div class="container">
			<h3>Website security &amp; malware protection for your website</h3>
    ...
    <div class="content-block plans" id="plans">
        <div class="container">
            ...
            <h4>Professional security features for your website</h4>

            <div class="row plan-comparison">
                {foreach $plans as $plan}
                    <div class="col-lg-{if count($plans) == 4}3{elseif count($plans) == 3}4{elseif count($plans) == 2}6{else}12{/if} col-md-{if count($plans) == 3}4{/if}">
                        <div class="plan">
                            <div class="header">
                                <h4>
                                    {$plan->name}
    ...
    <div class="content-block faq" id="faq">
        <div class="container">
			<div class="mw-928 mx-auto">
				<h2 class="block-title text-center">Frequently Asked Questions</h2>
				
				<div aria-multiselectable="true" class="panel-group" id="accordion" role="tablist">
					<div class="panel panel-default">
						<div class="panel-heading" id="faqOne" role="tab" aria-controls="collapseOne" aria-expanded="true" data-parent="#accordion" data-toggle="collapse" data-target="#collapseOne">
							<h4 class="panel-title">What is SiteLock?</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading" id="faqTwo" role="tab" aria-controls="collapseTwo" aria-expanded="false" class="collapsed" data-parent="#accordion" data-toggle="collapse" data-target="#collapseTwo">
							<h4 class="panel-title">What does SiteLock do?</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading" id="faqThree" role="tab" aria-controls="collapseThree" aria-expanded="false" class="collapsed" data-parent="#accordion" data-toggle="collapse" data-target="#collapseThree">
							<h4 class="panel-title">What types of issues does SiteLock scan for?</h4>
						</div>
						<div aria-labelledby="faqThree" class="panel-collapse collapse in" id="collapseThree" role="tabpanel">
							<div class="panel-body">
					...
					<div class="panel panel-default">
						<div class="panel-heading" id="faqFour" role="tab" aria-controls="collapseFour" aria-expanded="false" class="collapsed" data-parent="#accordion" data-toggle="collapse" data-target="#collapseFour">
							<h4 class="panel-title">What are vulnerabilities and malware?</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading" id="faqFive" role="tab" aria-controls="collapseFive" aria-expanded="false" class="collapsed" data-parent="#accordion" data-toggle="collapse" data-target="#collapseFive">
							<h4 class="panel-title">Will SiteLock impact website performance?</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading" id="faqSix" role="tab" aria-controls="collapseSix" aria-expanded="false" class="collapsed" data-parent="#accordion" data-toggle="collapse" data-target="#collapseSix">
							<h4 class="panel-title">What is the SiteLock Trust Seal?</h4>
						</div>
    ...
    <div class="content-block">
        <div class="container">
            <img class="img-responsive center-block" src="{$WEB_ROOT}/assets/img/marketconnect/sitelock/logo.png">
        </div>
    </div>
