...
<div class="landing-page weebly">
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="content-body-block col-md-6">
					...
					<p class="desc">{lang key="store.websiteBuilder.introduction"}</p>
                    <p class="desc">{lang key="store.websiteBuilder.ddEditorDescription"}</p>
                </div>
    ...
    <div class="content-block secondary pricing" id="pricing">
        <div class="container">
    ...
    <div class="content-block faq no-panel text-center" id="faq">
        <div class="container">
            <h2 class="block-title text-center">{lang key="store.websiteBuilder.faq.title"}</h2>
            <div class="row">
    ...
    <div class="content-block trusted-by text-center">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="block-title">{lang key="store.websiteBuilder.trust"}</h3>
                </div>
                <div class="col-sm-12">
                    <img src="{$WEB_ROOT}/assets/img/marketconnect/weebly/logo.png">
                </div>
