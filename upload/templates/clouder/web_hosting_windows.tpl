...
*}
		...
		<div class="mass-head">
			<div class="block-s5 no-padding-top hero-bg-wrap" style="background-image: url({$WEB_ROOT}/templates/{$template}/assets/images/hero-bg4.jpg);">
				<div class="container">
				<!--CONTENT-->
					...
					<div class="row">
						<div class="bg-shape-poly col-md-9">	
							...
							<div class="item padding-2x">
								<h1><i class="fab fa-windows"></i> Web Hosting</h1>
								<h2>Get a website that works It's quick and easy..</h2>
								<ul>
									<li><i class="fas fa-check"></i> State-of-the-Art Hosting Infrastructure</li>
									<li><i class="fas fa-check"></i> <b>99.9%</b> Uptime Guarantee</li>
									<li><i class="fas fa-check"></i> <b>45-Days</b> Money-Back Guarantee</li>
								</ul>
							</div>
			...
			<div class="container">
				<div class="TM-pricing-container">
					...
					<div class="page-switcher">
						<h2><i class="fab fa-windows"></i> Windows <small><a href="web_hosting.php">See Linux Plans</a></small></h2>
					</div>
						...
						<div class="panel-heading accordion-active">
							<a data-toggle="collapse" data-parent="#feature-list" href="#feature-1">
								<h5 class="panel-title">
									<span><i class="fa fa-plus bigger-110"></i></span> Web Hosting Features...
								</h5>
							</a>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading ">
							<a data-toggle="collapse" data-parent="#feature-list" href="#feature-2">
								<h5 class="panel-title">
									<span><i class="fa fa-plus bigger-110"></i></span> Free With Each Hosting Plan...
								</h5>
							</a>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<a data-toggle="collapse" data-parent="#feature-list" href="#feature-3">
								<h5 class="panel-title">
									<span><i class="fa fa-plus bigger-110"></i></span> cPanel Control Panel...
								</h5>
							</a>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<a data-toggle="collapse" data-parent="#feature-list" href="#feature-4">
								<h5 class="panel-title">
									<span><i class="fa fa-plus bigger-110"></i></span> Programming & Databases...
								</h5>
							</a>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<a data-toggle="collapse" data-parent="#feature-list" href="#feature-5">
								<h5 class="panel-title">
									<span><i class="fa fa-plus bigger-110"></i></span> Email Features...
								</h5>
							</a>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<a data-toggle="collapse" data-parent="#feature-list" href="#feature-6">
								<h5 class="panel-title">
									<span><i class="fa fa-plus bigger-110"></i></span> Premium Support...
								</h5>
							</a>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<a data-toggle="collapse" data-parent="#feature-list" href="#feature-7">
								<h5 class="panel-title">
									<span><i class="fa fa-plus bigger-110"></i></span> Application Hosting...
								</h5>
							</a>
						</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-9 center-block">
						...
						<p class="text-gray">No problem. Send us a ticket with your hosting needs and we’ll get back to you with a quote. Free of charge.</p>
