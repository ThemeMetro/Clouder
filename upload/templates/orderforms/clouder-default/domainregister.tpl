							...
							<form method="post" action="cart.php" id="frmDomainChecker">
								...
								<div class="input-group">
									...
									<span class="input-group-btn">
										<button type="submit"  id="btnCheckAvailability" class="btn btn-lg btn-secondary no-margin domain-check-availability{$captcha->getButtonClass($captchaForm)}" style="width: auto;">
