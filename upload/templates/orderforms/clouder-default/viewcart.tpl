                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 item-price">
                                                ...
                                                {else}
                                                    <span name="{$domain.domain}Price">{$domain.price}</span>
                                                    <div class="dropdown">
                                                        <button class="btn btn-default btn-xs btn-default dropdown-toggle" type="button" id="{$domain.domain}Pricing" name="{$domain.domain}Pricing" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                    ...
                                    {else}
                                        <form method="post" action="cart.php?a=view">
                                            <div class="form-group prepend-icon">
                                                ...
                                                <input type="text" name="promocode" id="inputPromotionCode" class="form-coontrol field" placeholder="{lang key="orderPromoCodePlaceholder"}" required="required">
